...
covoitApp.factory('daoEvents',  ['$http', function($http){
	...
	var REST_API_ROOT_URL = "http://localhost:8080/covoit-service/rest/";

	//var getAllUsers = function(callback) {
	//	$http.get(REST_API_ROOT_URL + '/users/users').success(callback);
	//};
		
	var getAllEvents = function(callback) {
		$http.get(REST_API_ROOT_URL + '/events/events').success(callback);
	};
	/*
